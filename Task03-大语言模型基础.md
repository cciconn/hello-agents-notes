...
## 实践记录
1.通过conda环境下创建虚拟环境my_ai_env，并安装transformers和torch。
2.在3.2.3的实操过程中，运行示例代码时一直报错，显示网络超时，通过DeepSeek得知是由于国内访问HuggingFace时常见的网络超时，需要在终端中直接安装huggingface_hub和Qwen/Qwen1.5-0.5B-Chat，由于网速缓慢，目前进度如下：<img width="3428" height="1898" alt="d1c1f896-e7ec-47e3-8a37-00f197a88283" src="https://github.com/user-attachments/assets/f317e7cb-2986-445f-887b-767824ec5636" />
